...
const getAllFriendsService = async (userId, cassandra) => {
  try {
...
const sendFriendRequestService = async (userId, friendId, cassandra) => {
...
const removeFriendService = async (userId, friendId, cassandra) => {
  console.log(friendId);
